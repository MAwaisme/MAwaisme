...
React • Next.js • TypeScript • Blockchain
...
[![Portfolio](https://img.shields.io/badge/Portfolio-000?style=flat-square&logo=vercel&logoColor=white)](https://geniusdev.lovable.app/)
...
- ⚡ Build modern frontend applications using **React.js & Next.js**
- 🔗 Integrate blockchain using **Ethers.js, Web3.js, Wagmi, RainbowKit**
- 🎨 Develop responsive and pixel-perfect UI with **Tailwind CSS & SCSS**
- 📊 Create scalable dashboards and admin panels
- 🔐 Connect smart contracts for NFT, DeFi & staking platforms
- 🤝 Collaborate in agile teams with designers & backend engineers
